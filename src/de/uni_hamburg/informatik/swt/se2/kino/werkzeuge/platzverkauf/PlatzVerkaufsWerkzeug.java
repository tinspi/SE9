...
public class PlatzVerkaufsWerkzeug
{
    ...
    {
        _ausgewaehlterGesamtbetrag = new Geldbetrag(0);
        if (istVerkaufenMoeglich(plaetze))
        {
            Geldbetrag preis = _vorstellung.getPreisFuerPlaetze(plaetze);
            _ui.getPreisLabel().setText("Gesamtpreis: " + preis + " Euro");
            _ausgewaehlterGesamtbetrag = new Geldbetrag(preis.getEurocent());
        }
        else if (istStornierenMoeglich(plaetze))
        {
            Geldbetrag preis = _vorstellung.getPreisFuerPlaetze(plaetze);
            _ui.getPreisLabel().setText("Gesamtstorno: " + preis + " Euro");
        }
